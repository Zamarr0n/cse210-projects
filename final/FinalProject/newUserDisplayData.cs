...
public class displayNewUserData {
    ...
    public displayNewUserData(string userName, int total_income,int total_expenses, int salary, int freelance_earnings, int rent, int groceries){
        ...
        Console.WriteLine($"» Budget for Groceries: ${groceries}");
            ...
            setNewUserData(userName, total_income,total_expenses, salary,freelance_earnings, rent, groceries);
            Console.WriteLine(" ");
    ...
    public (string, int, int, int, int, int, int) setNewUserData(string userName, int total_income , int total_expenses , int salary , int freelance_earnings, int rent, int groceries){
        _userName = userName;
